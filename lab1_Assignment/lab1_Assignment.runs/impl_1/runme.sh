...
HD_PWD='C:/Users/daryl/lab1_Assignment/lab1_Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_assignment_control_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1_assignment_control_module.tcl -notrace
