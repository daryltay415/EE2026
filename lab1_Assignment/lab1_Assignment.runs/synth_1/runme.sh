...
HD_PWD='C:/Users/daryl/lab1_Assignment/lab1_Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_assignment_control_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_assignment_control_module.tcl
