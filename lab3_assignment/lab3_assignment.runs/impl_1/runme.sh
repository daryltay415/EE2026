...
HD_PWD='C:/Users/daryl/lab3_assignment/lab3_assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_assignment_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_assignment_main.tcl -notrace
